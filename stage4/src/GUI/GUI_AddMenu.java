 ...
 * @author hmreg
 */
public class GUI_AddMenu extends javax.swing.JFrame {

    private GUI_ConcessionElements guiConcessionElements;
    
    /**
     * Creates new form GUI_AddMenu
     */
    public GUI_AddMenu() {
        initComponents();
    }

    public GUI_AddMenu(GUI_ConcessionElements guiConcessionElements) {
        initComponents();
    ...
    private void initComponents() {
        ...
        MenuNamelbl = new javax.swing.JLabel();
        IDTxt = new javax.swing.JTextField();
        ItemTxt = new javax.swing.JTextField();
        NewCostLbl = new javax.swing.JLabel();
        ...
        MenuLbl.setText("New Menu ID:");

        MenuNamelbl.setText("New Menu Item:");
        ...
        NewCostLbl.setText("New Item Cost:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(MenuNamelbl)
                    .addComponent(NewCostLbl))
                .addGap(46, 46, 46)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(ItemTxt)
                        .addComponent(IDTxt)
                        .addComponent(CostTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(35, 35, 35)
    ...
    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        ...
        try {
            id = Byte.parseByte(this.IDTxt.getText());
        ...
        try {
            cost = Byte.parseByte(this.CostTxt.getText());
        } catch (NumberFormatException e) {
            System.err.println(e.getMessage());
        }
        
        if(!MenuManager.contains(id)) {
            MenuManager.addMenu(new Food(id, name, cost));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_AddMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_AddMenu().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel MenuNamelbl;
    private javax.swing.JLabel NewCostLbl;
