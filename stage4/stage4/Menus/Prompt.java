...
public class Prompt {
    ...
    /**
     * Prompts user to sign in for stage4.TicketRelated.stage4.FoodRelated.Food stage4.TicketRelated.stage4.Staff duties
    ...
    public static Staff askForStaff() {
        ...
        do {
            ...
            // Invalid stage4.TicketRelated.stage4.Staff ID or name input
    ...
    public static Screen askForScreen() {
        ...
        System.out.println("stage4.TicketRelated.Screen does not exist!");
        return null;
    }
    ...
    public static String askStaffRole(){
        ...
        System.out.println("2. stage4.TicketRelated.stage4.FoodRelated.Food staff");
    ...
    public static Item askForItemRecipe(Food food) {
        ...
        System.out.println("stage4.TicketRelated.stage4.FoodRelated.Item does not exist in the recipe!");
        return null;
    }
    ...
    public static Item askForItemRecipe() {
        ...
        System.out.println("stage4.TicketRelated.stage4.FoodRelated.Item does not exist!");
        return null;
    }
