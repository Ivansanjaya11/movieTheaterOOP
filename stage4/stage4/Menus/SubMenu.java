...
public class SubMenu {
     ...
     */
    public static void addOrRemoveOrDisplayOrUpdateOrSearchScreen() {
        ...
        do {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    SubSubMenuTicket.searchScreenMenu();
                default:
                    stillContinue = false;
                    break;
            }
     ...
     */
    public static void addOrRemoveOrDisplayOrUpdateOrSearchMovie() {
        ...
        do {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    SubSubMenuTicket.searchMovieMenu();
                default:
                    stillContinue = false;
                    break;
            }
    ...
    public static void addOrRemoveOrDisplayOrUpdateOrSearchShowtime() {
        ...
        do {
            ...
            System.out.println("5. Search showtime");
            System.out.println("6. Return");
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    SubSubMenuTicket.searchShowtimeMenu();
                    break;
                default:
                    stillContinue = false;
                    break;
    ...
    public static void addOrRemoveOrDisplayOrUpdateOrSearchItem() {
    ...
    public static void addOrRemoveOrDisplayOrUpdateOrSearchFood() {
    ...
    public static void addOrRemoveOrDisplayOrUpdateOrSearchStaff() {
        ...
        do {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    SubSubMenuStaff.searchStaffMenu();
                    break;
                default:
                    stillContinue = false;
                    break;
